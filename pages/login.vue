    ...
    <div class="relative w-full max-w-md animate-fade-in">
      ...
      <div class="backdrop-blur-xl bg-obsidia-card/80 rounded-2xl border border-obsidia-border/50 shadow-glass p-8">
        ...
        <div class="text-center mb-8">
          <img src="/logo.png" alt="Obsidia" class="w-16 h-16 mx-auto mb-4 rounded-2xl shadow-glow-accent object-contain" />
          <h1 class="text-2xl font-bold text-obsidia-text">Obsidia Service</h1>
